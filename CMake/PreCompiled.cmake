...
##################################################################
# Support macro to use a precompiled header ( Modified Version )
# Usage:
#   use_precompiled_header(TARGET HEADER_PRECOMPFILE SRC_PRECOMPFILE DST_FILES )
##################################################################

macro(use_precompiled_header TARGET HEADER_FILE SRC_FILE DST_FILES )
  ...
  if (MSVC AND NOT NMAKE AND NOT OGRE_UNITY_BUILD)
	...
	set_source_files_properties(${DST_FILES}
