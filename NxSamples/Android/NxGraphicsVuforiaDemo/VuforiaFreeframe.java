...
public class VuforiaFreeframe
{
    ...
    public VuforiaFreeframe(Example activity, VuforiaSession session)
    {
        mActivity = activity;
        ...
        frameGL = new VuforiaFreeframeGL(mActivity, vuforiaAppSession);
    ...
    void renderScanningViewfinder(int quality)
    {
        ...
        //frameGL.renderViewfinder(); // crash !!!?? why
    }
