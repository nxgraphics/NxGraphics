...
public class VuforiaTargetRenderer implements GLSurfaceView.Renderer
{
    ...
    private VuforiaTeapot mTeapot;
    
    // Reference to main activity
    private Example mActivity;
    
    
    public VuforiaTargetRenderer(Example activity, VuforiaSession session)
    {
        mActivity = activity;
    ...
    private void renderFrame()
    {
        ...
        Renderer.getInstance().end();
         ...
         /*
        if( Example.GetInstance().IsOgreInitialized() ){ 
        	Example.GetInstance().RenderFrame();
    ...
    private void initRendering()
    {
        ...
        for (VuforiaTexture t : mTextures) // load teapot textures....
        {
