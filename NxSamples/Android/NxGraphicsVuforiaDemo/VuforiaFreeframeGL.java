...
public class VuforiaFreeframeGL
{
    ...
    public VuforiaFreeframeGL(Example activity, VuforiaSession session)
    {
        mActivity = activity;
        ...
        textures = new VuforiaTexture[TEXTURE_NAME.TEXTURE_COUNT];
    ...
    boolean init(int screenWidth, int screenHeight)
    {
        ...
        if ((shaderProgramID = VuforiaUtils.createProgramFromShaderSrc(
