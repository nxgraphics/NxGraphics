...
public class VuforiaGlView extends GLSurfaceView  
{
    ...
    public void init(boolean translucent, int depth, int stencil)
    {
        ...
        setEGLContextFactory(new ContextFactory( mContext, this.getHolder() ));
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory
    {
        ...
        ContextFactory( Context con, SurfaceHolder hold ) {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig eglConfig)
        {
            ...
            //EGLContext dd = OgreActivityJNI.GetEngineContext();
           ...
           // context = egl.eglGetCurrentContext();
            ...
            Log.i(LOGTAG, "Creating OpenGL ES 2.0 context : DONE");
