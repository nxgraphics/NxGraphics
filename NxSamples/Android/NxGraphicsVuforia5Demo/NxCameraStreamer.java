...
/* package */ final class NxCameraStreamer extends Object
{
    ...
    private static final String TAG = NxCameraStreamer.class.getSimpleName();
   ...
   // private final int mCameraIndex;
    ...
    /* package */ NxCameraStreamer(final int cameraIndex, final boolean useFlashLight, final int port,
    ...
    private void startStreamingIfRunning() throws IOException
    {
        ...
        final Camera camera = openFrontFacingCameraGingerbread();
